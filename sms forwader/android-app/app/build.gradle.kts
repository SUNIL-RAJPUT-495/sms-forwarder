...
android {
    ...
    defaultConfig {
        ...
        // Backend base URL — update this to your Firebase Functions URL or local emulator
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "BACKEND_BASE_URL",
                "\"http://10.0.2.2:5001/sms-forwarder-backend/us-central1/\"")
        }
        release {
...
dependencies {
    ...
    // ZXing (QR Code generation & barcode scanning)
